export default function Skills() {
  return (
    <div className="container my-24 mx-auto md:px-6">
      <section className="mb-32 bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        <div className="flex justify-center">
          <div className="max-w-[700px] text-center">
            <h2 className="mb-6 text-3xl font-bold">Flutter</h2>
            <p className="mb-16 text-neutral-500 dark:text-neutral-300">
              I love Flutter and have created apps as a freelancer for local
              clients. My projects include taxi apps, delivery apps, news apps,
              and some other personal apps to gain experience.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-x-6 md:grid-cols-2 lg:grid-cols-4 xl:gap-x-12">
          <div className="mb-12">
            <div className="flex">
              ...
              <div className="ml-2 grow">
                <p className="mb-1 font-bold">Clean code</p>
                <p className="text-neutral-500 dark:text-neutral-300">
                  I prioritize writting clean and scalable code.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="flex">
              ...
              <div className="ml-2 grow">
                <p className="mb-1 font-bold">SOLID</p>
                <p className="text-neutral-500 dark:text-neutral-300">
                  I love the creating files with single responsability, making
                  my code easy to read.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="flex">
              ...
              <div className="ml-2 grow">
                <p className="mb-1 font-bold">Android</p>
                <p className="text-neutral-500 dark:text-neutral-300">
                  I have created some apps and Android and learnt about its
                  configuration.
                </p>
              </div>
            </div>
          ...
          <div className="mb-12">
            <div className="flex">
              ...
              <div className="ml-2 grow">
                <p className="mb-1 font-bold">iOS</p>
                <p className="text-neutral-500 dark:text-neutral-300">
                  I have created some apps for iOS, similar configuration
                  process.
                </p>
              </div>
            </div>
          ...
          <div className="mb-12">
            <div className="flex">
              ...
              <div className="ml-2 grow">
                <p className="mb-1 font-bold">Google Play Store</p>
                <p className="text-neutral-500 dark:text-neutral-300">
                  I have deployed some apps on the Google Developer Console and
                  learnt some policies.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="flex">
              ...
              <div className="ml-2 grow">
                <p className="mb-1 font-bold">App Store</p>
                <p className="text-neutral-500 dark:text-neutral-300">
                  I have deployed some apps to the App Store, learnt interesting
                  policies there.
                </p>
              </div>
            </div>
          ...
          <div className="mb-12">
            <div className="flex">
              ...
              <div className="ml-2 grow">
                <p className="mb-1 font-bold">Clean code</p>
                <p className="text-neutral-500 dark:text-neutral-300">
                  I prioritize writing clean and scalable code.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="flex">
              ...
              <div className="ml-2 grow">
                <p className="mb-1 font-bold">SOLID</p>
                <p className="text-neutral-500 dark:text-neutral-300">
                  I love creating files with single responsibility, making my
                  code easier to read.
                </p>
              </div>
            </div>
          ...
          <div className="mb-12">
            <div className="flex">
              ...
              <div className="ml-2 grow">
                <p className="mb-1 font-bold">E2E Testing</p>
                <p className="text-neutral-500 dark:text-neutral-300">
                  I have done multiple E2E testing on Cypress, testing entires
                  user flows.
                </p>
              </div>
            </div>
